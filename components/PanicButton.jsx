...
export default function PanicButton() {
  ...
  return (
    <button
      onClick={handlePanic}
      className="fixed top-4 right-4 z-50 flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-full font-bold shadow-lg transition-all"
